...
export interface ApiBlogBlog extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    main_blogs: Schema.Attribute.Relation<
      'oneToMany',
      'api::blog-post.blog-post'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiChainPharmacySolutionChainPharmacySolution
  extends Struct.SingleTypeSchema {
  collectionName: 'chain_pharmacy_solutions';
  info: {
    displayName: 'ChainPharmacySolution';
    pluralName: 'chain-pharmacy-solutions';
    singularName: 'chain-pharmacy-solution';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    featureOverview: Schema.Attribute.Component<
      'solution.pharmacy-chain-feature-overview',
      false
    >;
    heroPharmacyChain: Schema.Attribute.Component<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chain-pharmacy-solution.chain-pharmacy-solution'
    > &
      Schema.Attribute.Private;
    operationsStandardization: Schema.Attribute.Component<
      'solution.operations-standardization',
      false
    >;
    operationsStandardizationBottom: Schema.Attribute.Component<
      'solution.operations-standardization',
      false
    >;
    pharmacyChainChallengesSection: Schema.Attribute.Component<
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blogSection: Schema.Attribute.Component<'home.blog-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaButton: Schema.Attribute.Component<'shared.cta-button', false>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    solutionSection: Schema.Attribute.Component<'home.solution-section', false>;
...
export interface ApiIndependentPharmacySolutionIndependentPharmacySolution
  extends Struct.SingleTypeSchema {
  collectionName: 'independent_pharmacy_solutions';
  info: {
    displayName: 'IndependentPharmacySolution';
    pluralName: 'independent-pharmacy-solutions';
    singularName: 'independent-pharmacy-solution';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    featureSection: Schema.Attribute.Component<
      ...
      false
    >;
    featureShowcaseSection: Schema.Attribute.Component<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::independent-pharmacy-solution.independent-pharmacy-solution'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    testimonialSection: Schema.Attribute.Component<
